...
public class HeapPage implements Page {
    ...
    public HeapPage(HeapPageId id, byte[] data) throws IOException {
		...
		header = new int[(numSlots/INT_BITS)+1];
...
//    	return res;
    ...
    public boolean getSlot(int i) {
    	//TODO: IMPLEMENT THIS
    	int headerNum = i/INT_BITS, slotNum = i%INT_BITS;
    	if(i<0 || headerNum>=header.length)
    		return false;
    	int headerSlots = header[headerNum];
    	int bitmask = 1<<slotNum;
    	
    	return (headerSlots & bitmask) > 0; // 1-> true; 0-> false;
	}
    ...
    private void setSlot(int i, boolean value) {
    	//TODO: IMPLEMENT THIS
    	int headerNum = i/INT_BITS, slotNum = i%INT_BITS;
    	if(getSlot(i) ^ value){ // XOR: 1^0 = 0^1 = 1;
    		header[headerNum] ^= (1<<slotNum); // @@ need to write to disk?
    	}
    }
